...
// `role: 'ADMIN'`, so a key created for a read-only reporting script could
// launch campaigns and spend the workspace wallet. The scope list below is
// deliberately small and resource-shaped: it is what the public API exposes.

export const API_SCOPES = Object.freeze([
  {
    id: 'messages:send',
    label: 'Send messages',
    description: 'Send WhatsApp template and text messages.',
  },
  {
    id: 'authentication:send',
    label: 'Send authentication OTPs',
    description: 'Send WhatsApp Authentication OTP messages.',
  },
  {
    id: 'templates:read',
    label: 'Read templates',
    description: 'List and read message templates.',
  },
  {
    id: 'templates:write',
    label: 'Manage templates',
    description: 'Create templates and submit them to Meta for review.',
  },
  {
    id: 'campaigns:read',
    label: 'Read campaigns',
    description: 'List campaigns and read their results.',
  },
  {
    id: 'campaigns:write',
    label: 'Manage campaigns',
    description: 'Create campaigns and launch them. Launching spends the wallet.',
  },
  {
    id: 'contacts:read',
    label: 'Read contacts',
    description: 'List and read contacts.',
  },
  {
    id: 'contacts:write',
  ...
  },
  {
    ...
    description: 'Change the workspace webhook URL.',
  },
  {
    id: 'analytics:read',
    label: 'Read analytics',
    description: 'Read overall workspace and campaign analytics.',
  },
  {
    id: 'automations:read',
    label: 'Read automations',
    description: 'List active automation workflows and intent rules.',
  },
  {
    id: 'automations:write',
    label: 'Manage automations',
    description: 'Trigger automations programmatically.',
  },
  {
    id: 'ai-agent:read',
    label: 'Read AI config',
    description: 'Read AI Agent persona and settings.',
  },
  {
    id: 'ai-agent:write',
    label: 'Query AI Agent',
    description: 'Send text to the AI Agent and receive a response.',
  },
  {
    id: 'wallet:read',
    label: 'Read wallet',
    description: 'Read wallet balance and transaction history.',
  },
]);

const VALID = new Set(API_SCOPES.map((s) => s.id));

// The set a key gets when the caller does not choose.
//
// Authentication sending is intentionally NOT added to the default list.
// A key must explicitly request `authentication:send`.
export const DEFAULT_SCOPES = Object.freeze([
  'messages:send',
  'templates:read',
  'campaigns:read',
...
// `null` scopes means a key issued before scopes existed.
// Those keep full access so existing integrations do not
// break on deploy.
//
