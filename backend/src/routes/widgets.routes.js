...
// Knowledge documents for the widget's assistant.
const upload = uploader(ACCEPTS.knowledge, 10 * 1024 * 1024);
...
router.post('/knowledge/upload', upload.single('file'), verifyFileContents, widgetsController.uploadSource);
