...
// CSV only, and the bytes must not look binary — see lib/uploadGuard.js.
...
router.post('/import', upload.single('file'), verifyFileContents, contactsController.importCsv);
