        ...
        <div style={{ width: '100%', maxWidth: '400px' }}>
          ...
          <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <button type="submit" disabled={status === 'loading' || status === 'success'}
              ...
              {(status === 'idle' || status === 'error') && <><I n="arrow" s={14} c="#07090F" /> Sign In</>}
              {status === 'loading' && <><svg width="14" height="14" viewBox="0 0 14 14" style={{ animation: 'spin 1s linear infinite' }}><circle cx="7" cy="7" r="5" fill="none" stroke="#07090F" strokeWidth="2" strokeDasharray="20" strokeDashoffset="5" /></svg> Signing in…</>}
